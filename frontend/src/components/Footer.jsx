        ...
        <>
            <footer className="bg-[#e6e6e6] pt-8 pb-10 shadow-lg">
                <div className="mx-auto w-full md:w-3/4 rounded-xl px-6 md:px-0">
                    <div className="mb-10 flex flex-col lg:flex-row gap-8 items-center lg:items-start lg:justify-between">
                        <div className="text-center lg:text-left">
                            <img className="w-48 lg:w-60 mx-auto lg:mx-0" src={fiksLogo} alt="fiks-logo" />
                        </div>
